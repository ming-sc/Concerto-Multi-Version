...
public class CookieLoginScreen extends ConcertoScreen {
    ...
    protected void init() {
        ...
        TextWidget textWidget = new TextWidget(this.width / 2 - 200, 20, 400, 10, new TranslatableComponent("concerto.screen.login.cookie"), this.font);
        this.addRenderableWidget(textWidget);

        this.field = new EditBox(this.font, this.width / 2 - 125, 30, 250, 20, TextComponent.EMPTY);
    ...
    private void tryLogin() {
        ...
        if (cookies.isEmpty()) {
            this.displayAlert(new TranslatableComponent("concerto.screen.login.cookie.empty"));
        } else {
            ...
            if (this.loginStatusUpdater.get()) {
                ...
                this.displayAlert(new TranslatableComponent("concerto.screen.login.cookie.failed"));
            }
        }
    }
}
