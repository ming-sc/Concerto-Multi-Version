...
public class NeteaseCloudUserScreen extends PageScreen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new ButtonBuilder(new TranslatableComponent("concerto.screen.daily_recommendation"),
    ...
    public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (!this.loggedIn()) {
            RenderUtil.renderCenteredString(matrices, this.font, new TranslatableComponent("concerto.screen.163.not_login"),
