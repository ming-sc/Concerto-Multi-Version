...
public class MusicAuditionScreen extends ConcertoScreen {
    ...
    public MusicAuditionScreen(Screen parent) {
        super(new TranslatableComponent("concerto.screen.audition"), parent);
    }
    ...
    public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (player == null || !player.hasPermissions(2)) {
            RenderUtil.renderCenteredString(matrices, this.font, new TranslatableComponent("concerto.screen.audition.permission_denied"),
