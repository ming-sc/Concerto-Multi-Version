...
public class CaptchaLoginScreen extends ConcertoScreen {
    ...
    protected void init() {
        super.init();
        this.usernameField = new EditBox(this.font, this.width / 2 - 30, 20, 90, 20, TextComponent.EMPTY);
        ...
        this.captchaButton = new ButtonBuilder(new TranslatableComponent("concerto.screen.login.get_captcha"), button -> {
        ...
        this.captchaField = new EditBox(this.font, this.width / 2 - 30, 50, 155, 20, TextComponent.EMPTY);
        this.addWidget(this.captchaField);
        this.addRenderableWidget(this.captchaField);
        TextWidget textWidget1 = new TextWidget(this.width / 2 - 120, 52, 90, 20, new TranslatableComponent("concerto.screen.login.captcha"), this.font);
