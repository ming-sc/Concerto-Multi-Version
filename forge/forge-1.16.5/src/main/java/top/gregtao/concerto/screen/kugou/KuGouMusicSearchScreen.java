...
public class KuGouMusicSearchScreen extends PageScreen {
    ...
    private <T extends WithMetaData> MetadataListWidget<T> initListsWidget() {
        return new MetadataListWidget<>(this.width, this.height, 42, this.height - 35, 18) {
            @Override
    ...
    public KuGouMusicSearchScreen(Screen parent) {
        super(new TranslationTextComponent("concerto.screen.search.kugou"), parent);
    }
    ...
    protected void init() {
        ...
        this.searchBox = new TextFieldWidget(this.font, this.width / 2 - 155, 17, 200, 20,
        ...
        this.infoButton = new ButtonBuilder(new TranslationTextComponent("concerto.screen.info"), button -> {
        ...
        this.addButton(new ButtonBuilder(new TranslationTextComponent("concerto.screen.search"),
            ...
            this.addButton(CyclingButtonWidget.<SearchType>builder(type -> new StringTextComponent(type.getI18nString())).values(SearchType.values()).initially(this.searchType).build(
                this.width / 2 + 105, 17, 65, 20, new TranslationTextComponent("concerto.search_type"),
        ...
        this.addButton(new ButtonBuilder(new TranslationTextComponent("concerto.screen.add"), button -> {
            switch (this.searchType) {
                case MUSIC: {
                    ConcertoListWidget<Music>.Entry entry = this.musicList.getSelected();
                    if (entry != null) {
