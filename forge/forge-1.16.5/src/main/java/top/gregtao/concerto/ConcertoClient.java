...
public class ConcertoClient {
	...
	public static class ClientForgeRegistry {
		/**
		...
		@SubscribeEvent
		public static void onClientAddReloadListeners(AddReloadListenerEvent event) {
			event.addListener(
					(IResourceManagerReloadListener) resourceManager -> {
						ConcertoRunner.run(() -> {
	...
	public static class ClientModRegistry {
		@SubscribeEvent
