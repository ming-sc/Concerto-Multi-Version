...
public class MusicInfoScreen extends ConcertoScreen {
    ...
    public MusicInfoScreen(Music music, Screen parent) {
        super(new TranslationTextComponent("concerto.screen.info"), parent);
        this.music = music;
    }
    ...
    protected void init() {
        ...
        Button requestButton = new ButtonBuilder(
                new TranslationTextComponent("concerto.screen.request"),
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        ...
        RenderUtil.renderText(matrices, this.font, this.music.getMeta().getSource(), this.width / 2 + 5, this.height / 2 - 20, 0xffffffff, false);
        RenderUtil.renderText(matrices, this.font, this.music.getMeta().title(), this.width / 2 + 5, this.height / 2 - 5, 0xffffffff, false);
        RenderUtil.renderText(matrices, this.font, this.music.getMeta().author(), this.width / 2 + 5, this.height / 2 + 10, 0xffffffff, false);
    }
}
