...
public class ConcertoListWidget<T> extends ExtendedList<ConcertoListWidget<T>.Entry> {
    public static final ResourceLocation INWORLD_MENU_LIST_BACKGROUND = new ResourceLocation(ConcertoClient.MOD_ID, "textures/gui/inworld_menu_list_background.png");
    public static final ResourceLocation INWORLD_HEADER_SEPARATOR = new ResourceLocation(ConcertoClient.MOD_ID, "textures/gui/inworld_header_separator.png");
    public static final ResourceLocation INWORLD_FOOTER_SEPARATOR = new ResourceLocation(ConcertoClient.MOD_ID, "textures/gui/inworld_footer_separator.png");
    ...
    public ITextComponent getNarration(int index, T t) {
        return new StringTextComponent(String.valueOf(index));
    }
    ...
    public void render(MatrixStack matrixStack, int pMouseX, int pMouseY, float pPartialTick) {
        RenderUtil.enableScissor(this.x0, this.y0, this.x1, this.y1);
    ...
    private void renderListSeparators(MatrixStack matrixStack) {
        ...
        GuiHelper.blit(matrixStack, INWORLD_HEADER_SEPARATOR, this.getLeft(), this.getTop() - 2, 0.0F, 0.0F, this.getWidth(), 2, 32, 2);
        GuiHelper.blit(matrixStack, INWORLD_FOOTER_SEPARATOR, this.getLeft(), this.getBottom(), 0.0F, 0.0F, this.getWidth(), 2, 32, 2);
        RenderSystem.disableBlend();
    }

    protected void renderListBackground(MatrixStack matrixStack) {
        RenderSystem.enableBlend();
        GuiHelper.blit(
                matrixStack,
