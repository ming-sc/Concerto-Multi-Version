...
import top.gregtao.concerto.port.logging.Log4JLoggerFactory;
import top.gregtao.concerto.util.ComponentUtil;

@Mod(value = ConcertoClient.MOD_ID)
public class ConcertoServer {

    public static Logger LOGGER = LogManager.getLogger("ConcertoServer");
    ...
    public static class ServerEvent {
        ...
        public static void onServerAddReloadListeners(AddReloadListenerEvent event) {
            event.addListener((IResourceManagerReloadListener) resourceManager -> reload());
        }
    }
}
