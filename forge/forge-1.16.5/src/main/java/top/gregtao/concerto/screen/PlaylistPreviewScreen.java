...
public class PlaylistPreviewScreen extends ConcertoScreen {
    ...
    public PlaylistPreviewScreen(Playlist playlist, Screen parent) {
        super(new StringTextComponent(new TranslationTextComponent("concerto." + (playlist.isAlbum() ? "album" : "playlist")).getString() +
    ...
    protected void init() {
        ...
        this.addButton(new ButtonBuilder(new TranslationTextComponent("concerto.screen.playlist.add"), button ->
        ...
        this.addButton(new ButtonBuilder(new TranslationTextComponent("concerto.playlist.export"), button -> {
            ITextComponent text = PresetPlaylistsConfig.saveToLocalPlaylists(this.playlist) ? new TranslationTextComponent("concerto.playlist.export.success") :
                    new TranslationTextComponent("concerto.playlist.export.fail");
