...
public class KuGouMusicLoginScreen extends ConcertoScreen {
    ...
    public static ITextComponent SOURCE_TEXT = new TranslationTextComponent("concerto.source.kugou_music");
                ...
                (username, password) -> {
                    try {
                        ...
                        if (optional.isPresent()) {
                            ...
                            return new TranslationTextComponent("concerto.login.kugou.success");
                        } else {
                            return new TranslationTextComponent("concerto.login.kugou.failed");
                        }
                    } catch (Exception e) {
                        return new TranslationTextComponent("concerto.login.kugou.error");
                    }
                },
                SOURCE_TEXT,
                this
