...
public class ConcertoScreen extends Screen {
    ...
    private AccessibilityOnboardingTextWidget message;
    ...
    protected void init() {
        ...
        this.message = this.addWidget(new AccessibilityOnboardingTextWidget(
                this.font, Component.empty(), this.width));
        this.message.visible = false;
        this.initTabNavigation();
    }
