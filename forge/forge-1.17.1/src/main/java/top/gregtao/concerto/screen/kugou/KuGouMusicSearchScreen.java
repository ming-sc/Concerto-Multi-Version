...
public class KuGouMusicSearchScreen extends PageScreen {
    ...
    public KuGouMusicSearchScreen(Screen parent) {
        super(new TranslatableComponent("concerto.screen.search.kugou"), parent);
    }
    ...
    protected void init() {
        ...
        this.infoButton = new ButtonBuilder(new TranslatableComponent("concerto.screen.info"), button -> {
        ...
        this.addRenderableWidget(CycleButton.<SearchType>builder(type -> new TextComponent(type.getI18nString())).withValues(SearchType.values()).withInitialValue(this.searchType).create(
                this.width / 2 + 105, 17, 65, 20, new TranslatableComponent("concerto.search_type"),
