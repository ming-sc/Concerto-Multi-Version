...
public class PlaylistPreviewScreen extends ConcertoScreen {
    ...
    public PlaylistPreviewScreen(Playlist playlist, Screen parent) {
        super(new TextComponent(new TranslatableComponent("concerto." + (playlist.isAlbum() ? "album" : "playlist")).getString() +
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new ButtonBuilder(new TranslatableComponent("concerto.screen.playlist.add"), button ->
        ...
        this.addRenderableWidget(new ButtonBuilder(new TranslatableComponent("concerto.screen.add"), button -> {
            ConcertoListWidget<Music>.Entry entry = this.widget.getSelected();
            if (entry != null) {
        ...
        this.addRenderableWidget(new ButtonBuilder(new TranslatableComponent("concerto.playlist.export"), button -> {
            Component text = PresetPlaylistsConfig.saveToLocalPlaylists(this.playlist) ? new TranslatableComponent("concerto.playlist.export.success") :
                    new TranslatableComponent("concerto.playlist.export.fail");
