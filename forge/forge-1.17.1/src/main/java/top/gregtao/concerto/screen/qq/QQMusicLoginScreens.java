...
public class QQMusicLoginScreens extends ConcertoScreen {
    ...
    public static Component SOURCE_TEXT = new TranslatableComponent("concerto.source.qq_music");
    ...
    protected void init() {
        super.init();
        this.addRenderableWidget(new ButtonBuilder(new TranslatableComponent("concerto.screen.login.type.qrcode.wechat"),
                button -> Minecraft.getInstance().setScreen(this.weChatQRLogin())
        ).size(100, 20).pos(this.width / 2 - 50, 40).build());
        this.addRenderableWidget(new ButtonBuilder(new TranslatableComponent("concerto.screen.login.type.qrcode.qq"),
