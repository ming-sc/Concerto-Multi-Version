...
public class QQMusicIndexScreen extends ConcertoScreen {
    ...
    public QQMusicIndexScreen(Screen parent) {
        super(new TranslatableComponent("concerto.screen.index.qq"), parent);
    }
    ...
    public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
        ...
        Component text = this.loggedIn() ? new TranslatableComponent("concerto.screen.qq.welcome", QQMusicApiClient.LOCAL_USER.nickname) :
                new TranslatableComponent("concerto.screen.qq.not_login");
