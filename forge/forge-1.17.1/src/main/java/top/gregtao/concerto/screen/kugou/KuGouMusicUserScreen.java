...
public class KuGouMusicUserScreen extends PageScreen {
    ...
    protected void init() {
        ...
        if (ClientConfig.INSTANCE.options.kuGouMusicLite) {
            this.addRenderableWidget(new ButtonBuilder(new TranslatableComponent("concerto.screen.daily_vip"),
                    button -> CompletableFuture.supplyAsync(
                        ...
                        displayAlert(new TranslatableComponent("concerto.screen.daily_vip." + text));
    ...
    public void render(PoseStack matrices, int mouseX, int mouseY, float delta) {
        ...
        if (!this.loggedIn()) {
            RenderUtil.renderCenteredString(matrices, this.font, new TranslatableComponent("concerto.screen.kugou.not_login"),
