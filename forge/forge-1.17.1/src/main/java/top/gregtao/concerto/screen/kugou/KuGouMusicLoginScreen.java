...
public class KuGouMusicLoginScreen extends ConcertoScreen {
    ...
    public static Component SOURCE_TEXT = new TranslatableComponent("concerto.source.kugou_music");
                ...
                (username, password) -> {
                    try {
                        ...
                        if (optional.isPresent()) {
                            ...
                            return new TranslatableComponent("concerto.login.kugou.success");
                        } else {
                            return new TranslatableComponent("concerto.login.kugou.failed");
                        }
                    } catch (Exception e) {
                        return new TranslatableComponent("concerto.login.kugou.error");
                    }
                },
                SOURCE_TEXT,
                this
