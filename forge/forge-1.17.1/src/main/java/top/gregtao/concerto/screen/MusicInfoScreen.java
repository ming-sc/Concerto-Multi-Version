...
public class MusicInfoScreen extends ConcertoScreen {
    ...
    public MusicInfoScreen(Music music, Screen parent) {
        super(new TranslatableComponent("concerto.screen.info"), parent);
        this.music = music;
    }
    ...
    protected void init() {
        ...
        Button requestButton = new ButtonBuilder(
                new TranslatableComponent("concerto.screen.request"),
