...
public class ConcertoServer {
    ...
    public static class ServerEvent {
        ...
        @SubscribeEvent
        public static void onServerAddReloadListeners(AddServerReloadListenersEvent event) {
            event.addListener(
                    ResourceLocation.fromNamespaceAndPath(ConcertoClient.MOD_ID, "music"),
                    (ResourceManagerReloadListener) resourceManager -> reload()
            );
        }
    }
}
